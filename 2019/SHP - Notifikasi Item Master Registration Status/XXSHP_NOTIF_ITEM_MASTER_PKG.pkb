...
--          LOGF('v_receipt'||v_recipient);
          ...
          v_email :=
             ...
             || crlf
             || crlf
             || 'Item Code, Item Desc, UOM, Item Template, Registration Status, Submitted By, Submission Date, Latest Update By, Latest Update On, Process Lead Time (Days), Item Toll Fee (Y/N), Item Unstandard (Y/N), Org Assignment (IO), Item Pecah KN (Y/N), IDC Status, Quality Status,    Planning Status,    FA Status,    Item Category Inventory Status,    Item Category GL Class Status,    Item Category Purchasing Status,    Item Category WMS Status,    Item Category Status, MAR & FA Status,    UOM Conversion Status,    Item Subinventory Status,    Approved Supplier List Status,    Manufacturers Status,    Bill of Distribution Status'
             || crlf;
