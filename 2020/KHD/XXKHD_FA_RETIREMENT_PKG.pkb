CREATE OR REPLACE PACKAGE BODY APPS.xxkhd_fa_retirement_pkg
...
--            logf('validasi 8 ok');
            SELECT fnd_profile.VALUE ('XXKHD_AR_TX_SOURCE_SALE_ASSET')
...
--              logf('validasi 9 ok');
            ...
            THEN
               ...
               v_err_cnt := v_err_cnt + 1;
               v_err_msg := v_err_msg || 'Value of Profile ''XXKHD_AR_TX_SOURCE_SALE_ASSET'' not Found';
            END IF;
