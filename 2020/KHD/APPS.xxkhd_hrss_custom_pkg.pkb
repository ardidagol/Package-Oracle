CREATE OR REPLACE PACKAGE BODY APPS.xxkhd_hrss_custom_pkg
AS
   ...
   BEGIN
      ...
      p_req_id :=
         fnd_request.submit_request (
            application   => 'XXKHD',
            program       => 'XXKHD_FA_ASSET_RETIREMENT',
   ...
   BEGIN
      ...
      p_req_id :=
         fnd_request.submit_request (
            application   => 'XXKHD',
            program       => 'XXKHD_FA_INTF_ADDITION',
   ...
   BEGIN
      ...
      INSERT INTO XXKHD_TEST_FILES (pl_id, pl_name, pl_file)
