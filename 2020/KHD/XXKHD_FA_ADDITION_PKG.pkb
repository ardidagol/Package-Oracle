CREATE OR REPLACE PACKAGE BODY APPS.xxkhd_fa_addition_pkg
/* $Header: XXKHD_FA_ADDITION_PKG 122.5.1.0 2016/11/24 15:56:00 Hansen Darmawan $ */
AS
   /**************************************************************************************************
       NAME: XXKHD_FA_ADDITION_PKG
       PURPOSE:
...
--             massadd_dist_id = v_mass_add_dist_id,
   ...
   BEGIN
      ...
      LOOP
         ...
         THEN
            v_ccid_flag := xxkhd_general_pkg.is_ccid_valid (v_concat_seg);
