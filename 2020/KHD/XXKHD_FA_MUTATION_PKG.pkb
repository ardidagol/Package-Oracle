CREATE OR REPLACE PACKAGE BODY APPS.xxkhd_fa_mutation_pkg
...
--      COMMIT;
   ...
   BEGIN
      ...
      LOOP
         ...
         --Change ccid validation, using xxkhd_general_pkg.is_ccid_valid
         /*SELECT COUNT (*)
           INTO v_ccid_cnt
