CREATE OR REPLACE PACKAGE APPS.xxmkt_fa_retirement_pkg AUTHID CURRENT_USER
...
/**************************************************************************************************
   ...
   **************************************************************************************************/
   ...
   g_ar_tax_code    zx_mco_lv_rates_v.tax_rate_code%type := fnd_profile.value('XXMKT_AR_TAX_RATE_CODE');
   --End EY
